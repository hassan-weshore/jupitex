		...
		<div data-nonce="<?php echo esc_attr( $nonce ); ?>" class="sellkit-notice-in-jupiterx notice is-dismissible">
			<p class="sellkit-notice-heading">
				...
				printf(
					...
					esc_html__( 'Your Default WooCommerce Checkout is %1$s! %2$s', 'jupiterx' ),
			...
			<div class="sellkit-notice-footer">
				<div class="sellkit-notice-buttons-wrapper">
					<a class="button button-primary jupiterx-notice-install-sellkit" href="#"><?php esc_html_e( 'Install Plugin Now', 'jupiterx' ); ?></a>
					<a class="button jupiterx-dismiss-sellkit-notice" href="#"><?php esc_html_e( 'I’m Not Interested', 'jupiterx' ); ?></a>
				</div>
				<span>
					<?php
					printf(
