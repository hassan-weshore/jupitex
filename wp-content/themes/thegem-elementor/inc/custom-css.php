...
.woocommerce .single-product-content .product-page__right-column .price{
    font-size: <?php echo intval(thegem_get_option('product_price_page_font_size')*0.7778); ?>px;
}
.woocommerce .single-product-content .product-page__right-column .price del{
    font-size: <?php echo intval(thegem_get_option('product_price_page_font_size')*0.6111); ?>px;
}
.woocommerce .single-product-content .single_variation .price del {
...
.woocommerce .single-product-content .product-page__right-column .price{
    line-height: <?php echo intval(thegem_get_option('product_price_page_line_height')*0.7778); ?>px;
}
.woocommerce .single-product-content .product-page__right-column .price del{
    line-height: <?php echo intval(thegem_get_option('product_price_page_line_height')*0.6111); ?>px;
}
<?php endif; ?>
...
.product-page__right-column .product-page__nav .product-page__nav-preview .nav-preview__info-title,
.product-page__right-column .reset_variations,
.product-page__right-column .size-guide a{
...
.product-page__right-column .product-page__nav .product-page__nav-preview:hover .nav-preview__info-title{
...
.product-page__right-column .reset_variations:hover,
.product-page__right-column .size-guide a:hover,
.product-page__right-column .product-page__nav .product-page__nav-list a:hover:before,
...
.preloader:after,
.loading:after {
	background-image: url('<?php echo get_template_directory_uri(); ?>/images/<?php echo thegem_get_option('content_preloader_style'); ?>.gif');
}
.preloader .preloader-spin,
.loading .preloader-spin {
	display: none;
...
.product-page__right-column .gem-button-style-outline.single_add_to_cart_button {
...
.product-page__right-column .gem-button-style-outline.single_add_to_cart_button:hover {
