	...
	<div class="jet-rating__control">
		...
		foreach ( $options as $key => $value ) {
			...
			<input
				...
				<?php echo $checked; ?>
			/>
			<label class="jet-rating-star__label" for="jet-rating-<?php echo $widget_id . '-' . $value ?>" <?php echo $this->type->get_tabindex_attr() ?>><span class="jet-rating-star__icon"><?php echo $args['rating_icon']; ?></span></label>
		<?php } ?>
			</fieldset>
		</div>
	</div>
