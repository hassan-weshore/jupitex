...
<div class="<?php echo implode( ' ', $classes ) ?>" <?php $this->filter_data_atts( $args ); ?>>
	<div class="jet-date-period__wrapper">
		<div class="jet-date-period__prev" <?php echo $this->type->get_tabindex_attr() ?>><i class="fa fa-chevron-left" aria-hidden="true"></i></div>
		<div class="jet-date-period__datepicker date">
			<div class="jet-date-period__datepicker-button input-group-addon" <?php echo $this->type->get_tabindex_attr() ?>><?php echo $datepicker_button_text ?></div>
			<input
		...
		<div class="jet-date-period__next" <?php echo $this->type->get_tabindex_attr() ?>><i class="fa fa-chevron-right" aria-hidden="true"></i></div>
	</div>
</div>
