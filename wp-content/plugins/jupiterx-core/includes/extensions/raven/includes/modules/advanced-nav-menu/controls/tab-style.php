...
class Tab_Style {
	...
	private function add_section_dropdown_menu( $widget ) {
		...
		$widget->add_group_control( 'typography',
			[
				...
				'fields_options' => [
					'font_size' => [
						'selectors' => [
							'{{WRAPPER}} nav.raven-adnav-menu-mobile ul.raven-adnav-menu li > a' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown ul.raven-adnav-menu li > a' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas ul.raven-adnav-menu li > a' => 'font-size: {{SIZE}}{{UNIT}};',
		...
		$widget->add_responsive_control( 'mobile_menu_item_padding',
			[
				...
				'selectors'  => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$widget->add_control( 'mobile_menu_item_divider_type',
			[
				...
				'selectors' => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li:not(:last-child)' => 'border-bottom-style: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-mobile ul.submenu' => 'border-top-style: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li:not(:last-child)' => 'border-bottom-style: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown ul.submenu' => 'border-top-style: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li:not(:last-child)' => 'border-bottom-style: {{VALUE}};',
		...
		$widget->add_control( 'mobile_menu_item_color',
			[
				...
				'default'   => '#111111',
				'selectors' => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$widget->add_control( 'mobile_menu_item_background_color',
			[
				...
				'type'      => 'color',
				'selectors' => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a' => 'background-color: {{VALUE}};',
		...
		$widget->add_control( 'hover_mobile_menu_item_color',
			[
				...
				'default'   => '#666666',
				'selectors' => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a:not(.active-link):hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a:not(.active-link):hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a:not(.active-link):hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a:not(.active-link).highlighted' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a:not(.active-link).highlighted' => 'color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a:not(.active-link).highlighted' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$widget->add_control( 'hover_mobile_menu_item_background_color',
			[
				...
				'type'      => 'color',
				'selectors' => [
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a:not(.active-link):hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a:not(.active-link):hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a:not(.active-link):hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-mobile .raven-adnav-menu li > a:not(.active-link).highlighted' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-dropdown .raven-adnav-menu li > a:not(.active-link).highlighted' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} nav.raven-adnav-menu-main.raven-adnav-menu-offcanvas .raven-adnav-menu li > a:not(.active-link).highlighted' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	private function add_section_dropdown_toggle_button( $widget ) {
		...
		$widget->add_responsive_control( 'toggle_button_color',
			[
				'label'       => esc_html__( 'Color', 'jupiterx-core' ),
				'type'        => 'color',
				'device_args' => [
		...
		$widget->add_responsive_control( 'toggle_button_background_color',
			[
				'label'     => esc_html__( 'Background Color', 'jupiterx-core' ),
				'type'      => 'color',
				'selectors' => [
		...
		$widget->add_responsive_control( 'hover_toggle_button_color',
			[
				'label'       => esc_html__( 'Color', 'jupiterx-core' ),
				'type'        => 'color',
				'device_args' => [
		...
		$widget->add_responsive_control( 'hover_toggle_button_background_color',
			[
				'label'     => esc_html__( 'Background Color', 'jupiterx-core' ),
				'type'      => 'color',
				'selectors' => [
