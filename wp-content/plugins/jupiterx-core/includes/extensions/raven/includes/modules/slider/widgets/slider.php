...
class Slider extends Base_Widget {
	...
	protected function render() {
		...
		<div class="elementor-swiper">
			<div class="raven-slider-wrapper elementor-main-swiper swiper-container" dir="<?php Utils::print_unescaped_internal_string( $direction ); ?>" data-animation="<?php echo esc_attr( $settings['content_animation'] ); ?>">
	...
	protected function content_template() {
		...
		#>
		<div class="elementor-swiper">
			<div class="raven-slider-wrapper elementor-main-swiper swiper-container" dir="{{ direction }}" data-animation="{{ settings.content_animation }}">
				<div class="swiper-wrapper raven-slider">
