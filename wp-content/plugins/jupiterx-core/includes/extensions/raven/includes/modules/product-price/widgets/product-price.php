...
class Product_Price extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-product-type-simple .price ins, {{WRAPPER}} .raven-product-type-simple .price del, {{WRAPPER}} .raven-product-type-external .price ins, {{WRAPPER}} .raven-product-type-external .price del, {{WRAPPER}} .raven-product-type-grouped .price, {{WRAPPER}} .raven-product-type-variable .price',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-product-type-simple .price ins, {{WRAPPER}} .raven-product-type-external .price ins, {{WRAPPER}} .raven-product-type-grouped .price ins, {{WRAPPER}} .raven-product-type-variable .price ins',
				'exclude' => [ 'word_spacing' ],
			]
		);
	...
	protected function render() {
		...
		$this->start_price_wrapper( $product_type );
	...
	private function start_price_wrapper( $product_type ) {
		echo sprintf( '<div class="raven-product-type-%s">', $product_type );
	}
