...
class Module extends Module_Base {
	...
	public function modify_widget_before_rendering() {
		$preview    = filter_input( INPUT_GET, 'preview', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
		$library    = filter_input( INPUT_GET, 'elementor_library', FILTER_SANITIZE_FULL_SPECIAL_CHARS );
		$preview_id = filter_input( INPUT_GET, 'preview_id', FILTER_SANITIZE_NUMBER_INT );

		if ( empty( $preview ) || empty( $library ) || empty( $preview_id ) ) {
			return;
		}
