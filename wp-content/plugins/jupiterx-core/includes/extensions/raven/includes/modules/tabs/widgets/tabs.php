		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .raven-tabs-vertical .raven-tabs-list .raven-tabs-title, {{WRAPPER}} .raven-tabs-reversed-vertical .raven-tabs-list .raven-tabs-title' => '{{VALUE}}',
				],
				'condition' => [
	...
	private function register_styles_hover_tab() {
		...
		$this->add_control(
			...
			[
				...
				'type' => 'color',
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-title:hover .raven-tabs-title-icon:not({{WRAPPER}} .raven-tabs-active.raven-tabs-title:hover .raven-tabs-title-icon)' => 'color: {{VALUE}};',
	...
	private function register_styles_ative_tab() {
		...
		$this->add_control(
			...
			[
				...
				'type' => 'color',
				'selectors' => [
					'{{WRAPPER}} .raven-tabs-active .raven-tabs-title-icon' => 'color: {{VALUE}};',
