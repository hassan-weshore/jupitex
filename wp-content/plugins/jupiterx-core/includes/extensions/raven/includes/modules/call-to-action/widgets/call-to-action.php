...
class Call_To_Action extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'button_color',
			[
				'label' => esc_html__( 'Button Color', 'jupiterx-core' ),
				'type' => 'color',
				'selectors' => [
					'{{WRAPPER}} .raven-cta__button' => 'color: {{VALUE}}; border-color: {{VALUE}}',
				],
				'condition' => [
					'button!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => 'color',
				'selectors' => [
					'{{WRAPPER}} .raven-cta:hover .raven-cta__button' => 'color: {{VALUE}}; border-color: {{VALUE}}',
				],
				'condition' => [
					'button!' => '',
				],
	...
	protected function content_template() {
		...
		<#
			...
			if ( 'icon' === settings.graphic_element ) {
				var iconWrapperClasses = 'elementor-icon-wrapper';
					iconWrapperClasses += ' raven-cta__image';
				...
				view.addRenderAttribute( 'graphic_element', 'class', 'raven-cta__image' );
			}
			...
			view.addRenderAttribute( 'title', 'class', [ 'raven-cta__title', 'raven-cta__content-item', 'elementor-content-item' ] );
			view.addRenderAttribute( 'description', 'class', [ 'raven-cta__description', 'raven-cta__content-item', 'elementor-content-item' ] );
			view.addRenderAttribute( 'button', 'class', [ 'raven-cta__button', 'elementor-button', btnSizeClass ] );
			view.addRenderAttribute( 'graphic_element', 'class', [ 'raven-cta__content-item', 'elementor-content-item' ] );
		...
		<{{ wrapperTag }} class="raven-cta" {{{ view.getRenderAttributeString( 'wrapper' ) }}}>

		<# if ( printBg ) { #>
			<div class="raven-cta__bg-wrapper">
				<div class="raven-cta__bg elementor-bg" {{{ view.getRenderAttributeString( 'background_image' ) }}}></div>
				<div class="raven-cta__bg-overlay"></div>
			</div>
		<# } #>
		<# if ( printContent ) { #>
			<div class="raven-cta__content">
				...
				<# if ( settings.button ) { #>
					<div class="raven-cta__button-wrapper raven-cta__content-item elementor-content-item {{ animationClass }}">
		...
		<# if ( settings.ribbon_title ) {
			var ribbonClasses = 'raven-ribbon';

			if ( settings.ribbon_horizontal_position ) {
				ribbonClasses += ' raven-ribbon-' + settings.ribbon_horizontal_position;
			}
		#>
			<div class="{{ ribbonClasses }}">
				<div class="raven-ribbon-inner">{{{ settings.ribbon_title }}}</div>
			</div>
		<# } #>
		</{{ wrapperTag }}>
		<?php
