...
if ( ! class_exists( 'JupiterX_Core' ) ) {
	...
	class JupiterX_Core {
		...
		/**
		 * Check jupiterx is activated.
		 *
		 * @since 2.5.3
		 * @return boolean
		 */
		private function jupiterx_is_activated() {
			$jupiterx        = wp_get_theme();
			$jupiterx_themes = [
				'jupiterx',
				'jupiterx-lite',
				'jupiterx-child',
			...
			if ( in_array( $jupiterx->get( 'TextDomain' ), $jupiterx_themes, true ) ) {
				return true;
			}
